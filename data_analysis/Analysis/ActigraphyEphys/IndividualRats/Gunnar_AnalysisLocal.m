% Gunnar 5/7 Day Video Analysis
% Noah Muscat
% data ran from /data/Jeremy/Gunnar using actigraphy_v5.py
%% Combines all csv files for all folders under 'data'
% Set the parent directory where the 'data' folder is located.
parentDir = '/Volumes/data/Jeremy/Gunnar';
folder_name1 = 'Gunnar_240614_Videos';
folder_name2 = 'Gunnar_240606_Videos';
...
%% Gunnar240606
make_ZT_bool = true;
Per_Day_Analysis('Gunnar_240606_Videos_Most_combined_data.csv','Most Movement', 'Gunnar',make_ZT_bool)

% analysis for totals
Most_Mov = readtable('Gunnar_240606_Videos_Most_combined_data.csv');
convert_ZT = true;
if convert_ZT
...
%% Gunnar240614
make_ZT_bool = true;
Per_Day_Analysis('Gunnar_240614_Videos_Most_combined_data.csv','Most Movement', 'Gunnar',make_ZT_bool)

% analysis for totals
Most_Mov = readtable('Gunnar_240614_Videos_Most_combined_data.csv');
convert_ZT = true;
if convert_ZT
    Most_Mov = make_ZT(Most_Mov, 5);
end
