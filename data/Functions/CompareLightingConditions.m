function CompareLightingConditions(datafile300_week1, datafile1000_week1, datafile1000_week4, convert_ZT)
    ...
    [h3, p3] = ttest2(hourlySum1000_week1, hourlySum1000_week4);
    disp(['Two-sample t-test p-value (1000 Lux Week1 vs 1000 Lux Week4): ', num2str(p3)]);
    ...
    b.CData(3,:) = [0.2, 0.5, 0.2]; % Color for 1000 Lux Week 4
    ...
    line_y = y_max; % Use the same y level for the first and third comparisons
